...
import { idlFactory } from './vaquitaicp.did.js';
export { idlFactory } from './vaquitaicp.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_VAQUITAICP;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./vaquitaicp.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the vaquitaicp canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./vaquitaicp.did.js")._SERVICE>}
 */
export const vaquitaicp = createActor(canisterId);
